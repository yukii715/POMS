...
public class StockReportViewer extends javax.swing.JDialog {
    ...
    private String[] reportColumnName = {"ID", "Name", "Category", "Type", "Stock", "Status"};

    
    public StockReportViewer(javax.swing.JDialog parent, boolean modal, Report report) {
        super(parent, modal);
        initComponents();
    ...
    private void Report(){
        ...
        var list = report.getStockReport();
        
        for (StockReport sr : list) {
            reportModel.addRow(new String[]{
                sr.getItemID(),
                sr.getItemName(),
                sr.getItemCategory(),
                sr.getItemType(),
                String.valueOf(sr.getStock()),
                sr.getStatus().name()
            });
        }
